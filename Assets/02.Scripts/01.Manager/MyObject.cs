...
public class MyObject : MonoBehaviour
{
    ...
    public Equipment EquippedHelmet;   //Åõ±¸
    public Equipment EquippedChest;    //°©¿Ê
    public Equipment EquippedWeapon;   //¹«±â
    public Equipment EquippedShield;   //¹æÆÐ[º¸Á¶¹«±â]

    public Equipment EquippedPants;    //ÇÏÀÇ
    public Equipment EquippedBoots;    //½Å¹ß
    public Equipment EquippedRing;     //¹ÝÁö
    public Equipment EquippedAmulet;   //¸ñ°ÉÀÌ
    public Equipment EquippedBelt;     //º§Æ®
